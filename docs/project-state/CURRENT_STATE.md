...
P8-B2_NEXT: Sol independent verification of LIVE-01 PARTIAL evidence; then re-run LIVE-01 (investigate provider timeout / Harness process stability) per LIVE-00 boundary
