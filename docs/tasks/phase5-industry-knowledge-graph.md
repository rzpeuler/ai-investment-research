...
**COMPLETED_MILESTONE: M2_PERSISTENCE_AND_ONTOLOGY_SEED**
**NEXT_MILESTONE: M3_CANDIDATE_INGEST**
**NEXT_MILESTONE_AUTHORIZATION: PENDING**

> M1 PASS（SHA `b097996`）。M2 PASS（SHA `565d500`，CI `31171415215`）。
> M2 PASS 不自动授权 M3。M3-M10 须各自独立授权。
