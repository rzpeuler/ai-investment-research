...
class ScenarioChatSpec:
    ...
    industry_policy: Literal["ignore_profile", "explicit", "explicit_or_profile"] = "ignore_profile"
...
_SPECS = {
    ...
    "industry_research": ScenarioChatSpec("industry_research", "chat_industry_research_input", "industry_required", "system_as_of", ("industry",), builders.build_industry, drafts.complex_requires_llm, "explicit"),
    "theme_discovery": ScenarioChatSpec("theme_discovery", "chat_theme_discovery_input", "optional", "system_as_of", ("theme_or_industry",), builders.build_theme, drafts.complex_requires_llm, "explicit"),
    ...
    "first_coverage": ScenarioChatSpec("first_coverage", "chat_first_coverage_input", "profile_and_industry_required", "system_as_of", ("target", "industry"), builders.build_first_coverage, drafts.complex_requires_llm, "explicit_or_profile"),
}
